...
$consult1="SELECT idreclamo_foto, rfnombre, reclamo_idreclamo FROM reclamo_foto WHERE usuario_idusuario = '$usu' AND idreclamo_foto > '$id' AND reclamo_idreclamo = '$reclamo_idreclamo' ORDER BY idreclamo_foto ASC LIMIT 1";

...
$consult2="UPDATE reclamo SET restado ='0', rfechabaja ='$fecha' WHERE  usuario_idusuario = '$usu' AND idreclamo='$idreclamo'";

if(!$result2 = $db->query($consult2)){  die('Ocurrió un error1: [' . $db->error . ']'); }





$ndetalle = 'SE FINALIZO EL PEDIDO';

$consult3="INSERT INTO notificaciones ( ndetalle, reclamo_idreclamo, nusuario_idusuario, ntipo ) VALUES ('$ndetalle', '$idreclamo', '$usu', '3')";

if(!$result3 = $db->query($consult3)){  die('Ocurrió un error2: [' . $db->error . ']'); }
...
if(!$result4 = $db->query($consult4)){  die('Ocurrió un error3: [' . $db->error . ']'); }
...
<div class="alert alert-success alert-with-icon" data-notify="container" role="alert">

<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>

SE FINALIZO UN RECLAMO. 

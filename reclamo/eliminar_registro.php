...
$ndetalle = 'SE ELIMINO EL PEDIDO';

$consult3="INSERT INTO notificaciones ( ndetalle, reclamo_idreclamo, nusuario_idusuario, ntipo ) VALUES ('$ndetalle', '$idreclamo', '$usu', '4')";
...
$consult2="DELETE FROM reclamo WHERE usuario_idusuario = '$usu' AND idreclamo='$idreclamo'";

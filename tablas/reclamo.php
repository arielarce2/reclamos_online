        ...
        <nav class="navbar navbar-default">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-info btn-fill btn-wd" id="nuevo-producto" >Nuevo Reclamo</button>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b><center>Reclamo</center></b></h4>
                ...
                <table border="0" width="100%">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-control" name="rreclamo_estado" id="rreclamo_estado">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <input class="form-control" type="date" name="rfecha" id="rfecha" placeholder="Fecha" required/>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Nuevo" class="btn btn-info btn-fill btn-wd" id="reg"/>
